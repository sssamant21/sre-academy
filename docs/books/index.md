...
The SRE Academy books organize documentation by platform and operational domain. Each book can grow independently while following the same structure for concepts, hands-on labs, runbooks, and troubleshooting notes.
...
| Kafka | Event streaming operations, topic design, consumer health, capacity, and recovery. |
