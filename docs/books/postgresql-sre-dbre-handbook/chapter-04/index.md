...
- [4.1 -- PostgreSQL Storage Architecture Overview](4.1-postgresql-storage-architecture-overview.md) -- Planned
- [4.2 -- PostgreSQL Data Directory and Physical Layout](4.2-postgresql-data-directory-and-physical-layout.md) -- Planned
...
Chapter 4 structure is planned and published in the PostgreSQL SRE & DBRE Handbook navigation.
